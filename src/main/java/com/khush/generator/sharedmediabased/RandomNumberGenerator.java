package com.khush.generator.sharedmediabased;
...
public class RandomNumberGenerator {
    ...
    private final DistributedQueue<Integer, PrimeResult> sharedQueue;

    public RandomNumberGenerator(final DistributedQueue<Integer, PrimeResult> sharedQueue,
    ...
    private class PrimeResultReceiverRunnable implements Runnable {
        ...
        public void run() {
            while (true) {
                PrimeResult result = sharedQueue.poll();
